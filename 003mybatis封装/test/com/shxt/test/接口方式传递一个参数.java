 ...
 * @see 新建|修改|放弃
 * @see com.shxt.test.接口方式传递一个参数
 */

public class 接口方式传递一个参数 {
    private final static Logger logger = Logger.getLogger(接口方式传递一个参数.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // sqlSession.getMapper(UserDao.class).query("Helena");
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("account", "Helena");
            map.put("password", "2");
            sqlSession.getMapper(UserDao.class).query02(map);
        } catch (Exception e) {
